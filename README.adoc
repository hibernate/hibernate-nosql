...
image:https://img.shields.io/github/actions/workflow/status/hibernate/hibernate-nosql/ci.yml?branch=main&logo=GitHub&style=for-the-badge[GitHub Actions Status,link=https://github.com/hibernate/hibernate-nosql/actions/workflows/ci.yml?query=branch%3Amain]
