...
If you're looking for information about how to release Hibernate NoSQL, see link:/MAINTAINERS.md[MAINTAINERS.md]
...
Hibernate NoSQL also publishes SNAPSHOT releases using an automated link:../ci/snapshot-publish.Jenkinsfile[Jenkins pipeline],
