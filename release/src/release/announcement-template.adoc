= Hibernate NoSQL {version}
Steve Ebersole
:awestruct-tags: ["Hibernate NoSQL", "Releases"]
:awestruct-layout: blog-post

:version: 6.4.0.CR1
:family: 6.4

:docs-url: https://docs.jboss.org/hibernate/nosql/{family}
...
- the https://hibernate.org/nosql/releases/6.0/[release page]
